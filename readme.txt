...
<p>If you are using wordpress 2.3 or higher, or your blog version is lower than wordpress 2.3 but you have used UltimateTagWarrior plugins before,from the WordPress Administration Panels, choose <b>Dashboard > TagALLY > Manage</b>, you'll be able to use one-click method to export your posts and related tags.</p>
...
<p>If your blog version is lower than wordpress 2.5, Go to the WordPress Administration <b>Presentation > Widgets</b> Panel, drag the <b>"TagAlly-for-WP:TagCloud"</b> to your sidebar. For wordpress 2.5 or higher, Go to <b>Design > Widgets</b> Panel, find out 'TagAlly: Tag Cloud' and press 'Add' beside it. Finally, <b>Don't forget to press 'Save Changes' button to save your setting.</b>
</p>
...
== Upgrading to version 0.31 from version 0.1 or 0.2 or 0.25 or 0.3 ==
<p>Copy the new files to your '/wp-content/plugins/tagally-for-wp' directory, overwriting old files. You also make use of 'Plugin Update Notification' of wordpress 2.3 or higher to upgrade your plugin.
</p>
